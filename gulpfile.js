...
gulp.task('build', function (done) {
  ...
  runSequence('env:dev', 'wiredep:prod', ['uglify', 'cssmin'], done);	// NSE
});
...
gulp.task('default', function (done) {
  ...
  runSequence('env:dev', ['copyLocalEnvConfig', 'makeUploadsDir'], ['nodemon', 'watch'], done);	// NSE
});

// Run the project in production mode
gulp.task('prod', function (done) {
  //runSequence(['copyLocalEnvConfig', 'makeUploadsDir', 'templatecache'], 'build', 'env:prod', 'lint', ['nodemon-nodebug', 'watch'], done);
  runSequence(['copyLocalEnvConfig', 'makeUploadsDir', 'templatecache'], 'build', 'env:prod', ['nodemon-nodebug', 'watch'], done);	// NSE
});
