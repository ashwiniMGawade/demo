...
var path = require('path'),
  should = require('should'),
  middleware = require(path.resolve('./config/lib/sanitizer'));
...
describe('Middleware.sanitizer', function() {
    ...
    it('should sanitize XSS from body', function() {
        middleware()(req, {}, next);
        (req.body.test1).should.equal('This is clean');
        (req.body.test2).should.equal('This  isnt!');
        (req.body.test3).should.equal('Im technically allowed.');
        should.equal(req.body.test4, null);
        (req.body.test5).should.equal(1);
        (req.body.test6).should.equal('This  work');
    });
