...
exports.read = function (req, res) {
  if (!_.includes(req.user.roles, 'root')) {
    ...
    Job.findById(req.job._id, 'tenant partner user operation module payload result status object created updated').exec(function (err, job) {
      res.json(job);
    });
  }
};
...
exports.list = function (req, res) {
  ...
  var query =  Job.find({},  'tenant user partner module operation created updated status object').sort('-created');
...
exports.jobByID = function (req, res, next, id) {
  ...
  Job.findById(id, 'tenant user partner operation module payload result status object created updated')
